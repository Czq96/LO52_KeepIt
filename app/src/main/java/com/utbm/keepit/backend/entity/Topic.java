...
public class Topic {
    ...
    private List<Topic> listExercises;
     ...
     */
    @Generated(hash = 1195688572)
    public List<Topic> getListExercises() {
        if (listExercises == null) {
            ...
            List<Topic> listExercisesNew = targetDao._queryTopic_ListExercises(id);
            synchronized (this) {
                if (listExercises == null) {
